...
urlpatterns = [
    ...
    url(r'^portfolio/(?P<portfolio_id>\d+)/addstock(?P<stock>\w+)$', api.add_stock, name="add_stock"),
    url(r'^portfolio/(?P<portfolio_id>\d+)/removestock(?P<stock>\w+)$', api.remove_stock, name="remove_stock"),
